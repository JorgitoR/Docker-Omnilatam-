...
# Signals
from omnilatam.apps.notificacion.signals import notify
...
class NotificacionAbstract(models.Model):
	...
	def timesince(self, now=None):
		...
		return timesince(self.timestamp, nowe)
...
def notification(verb, **kwargs):
	...
	Notify = load_model('notificacion', 'notificacion')
...
notify.connect(notification, dispatch_uid='notificacion.models.notificacion')